...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("seed1", "161.97.112.31"));
        vSeeds.push_back(CDNSSeedData("seed2", "45.32.184.252"));
        vSeeds.push_back(CDNSSeedData("seed3", "104.207.130.31"));
        vSeeds.push_back(CDNSSeedData("seed4", "95.179.217.187"));
        vSeeds.push_back(CDNSSeedData("seed5", "95.179.142.112"));
        vSeeds.push_back(CDNSSeedData("seed6", "136.244.107.0"));
        vSeeds.push_back(CDNSSeedData("seed7", "45.77.224.220"));
