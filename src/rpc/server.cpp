...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SLDS features */
        {"solidus", "listmasternodes", &listmasternodes, true },
        {"solidus", "getmasternodecount", &getmasternodecount, true },
        {"solidus", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"solidus", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"solidus", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"solidus", "masternodecurrent", &masternodecurrent, true },
        {"solidus", "startmasternode", &startmasternode, true },
        {"solidus", "createmasternodekey", &createmasternodekey, true },
        {"solidus", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"solidus", "listmasternodeconf", &listmasternodeconf, true },
        {"solidus", "getmasternodestatus", &getmasternodestatus, true },
        {"solidus", "getmasternodewinners", &getmasternodewinners, true },
        {"solidus", "getmasternodescores", &getmasternodescores, true },
        {"solidus", "preparebudget", &preparebudget, true },
        {"solidus", "submitbudget", &submitbudget, true },
        {"solidus", "mnbudgetvote", &mnbudgetvote, true },
        {"solidus", "getbudgetvotes", &getbudgetvotes, true },
        {"solidus", "getnextsuperblock", &getnextsuperblock, true },
        {"solidus", "getbudgetprojection", &getbudgetprojection, true },
        {"solidus", "getbudgetinfo", &getbudgetinfo, true },
        {"solidus", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"solidus", "mnfinalbudget", &mnfinalbudget, true },
        {"solidus", "checkbudgets", &checkbudgets, true },
        {"solidus", "mnsync", &mnsync, true },
        {"solidus", "spork", &spork, true },
...
{
    return "> solidus-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8200/\n";
}
