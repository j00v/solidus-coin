...
/* Solidus GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Solidus"
#define QAPP_ORG_DOMAIN "solidus.org"
#define QAPP_APP_NAME_DEFAULT "Solidus-Qt"
#define QAPP_APP_NAME_TESTNET "Solidus-Qt-testnet"
