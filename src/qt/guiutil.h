...
/** Utility functions used by the Solidus Qt UI.
 */
namespace GUIUtil
{
...
// Render SLDS addresses in monospace font
...
// Parse "solidus:" URI into recipient object, return true on successful parsing
