...
#define PACKAGE_BUGREPORT "https://github.com/soliduscoin/soliduscoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "CryptoFlow Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "CryptoFlow Core 2.0.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "solidus"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://solidus.finance/"
