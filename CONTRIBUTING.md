Contributing to CryptoFlow Core
============================

The CryptoFlow Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the CryptoFlow Coreunit tests or QA tests
...
The following applies to code changes to the CryptoFlow Core project, and is not to be
confused with overall CryptoFlow Network Protocol consensus changes.

Whether a pull request is merged into CryptoFlow Core rests with the project merge
...
Patches that change CryptoFlow consensus rules are considerably more involved than
...
Where a patchset proposes to change the CryptoFlow consensus, it must have been
...
The project leader is the release manager for each CryptoFlow Core release.
