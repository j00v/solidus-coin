...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the solidus repository."
  exit 1
fi
...
echo
echo 'When compiling solidusd, run `./configure` in the following way:'
echo
echo "  export BDB_PREFIX='${BDB_PREFIX}'"
echo '  ./configure BDB_LIBS="-L${BDB_PREFIX}/lib -ldb_cxx-4.8" BDB_SLDSAGS="-I${BDB_PREFIX}/include" ...'
