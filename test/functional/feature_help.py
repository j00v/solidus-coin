...
"""Verify that starting solidus with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start solidus with -? for help text")
        ...
        self.log.info("Start solidus with -version for version information")
